all: bin/main bin/chessviz-test

bin/main: build/src/main.o build/src/board_print_plain.o build/src/board.o
	gcc -Wall -Werror build/src/main.o build/src/board_print_plain.o build/src/board.o -o bin/main
...
build/test/board_test.o: test/board_test.c
	gcc -Wall -Werror -c test/board_test.c -o build/test/board_test.o
